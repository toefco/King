...
const simpleContent = `import { useState, useRef, useEffect } from 'react';
...
fs.writeFileSync(path.join(__dirname, 'src', 'components', 'Layout', 'DataManager.tsx'), simpleContent);
console.log('✅ 已创建简化版 DataManager.tsx！');
